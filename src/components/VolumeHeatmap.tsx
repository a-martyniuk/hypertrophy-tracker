...
export const VolumeHeatmap = ({ currentMeasurements, referenceMeasurements, sex = 'male', onMarkerClick }: Props) => {
    ...
    const MALE_PATHS = {
        ...
        "thigh-left": "M 104.0,247.3 104.0,299.3 110.6,325.3 117.9,345.3 120.5,357.3 159.6,357.3 159.6,312.7 153.6,284.0 144.4,258.7 143.0,248.0 142.4,247.3 Z",
        "calf-left": "M 120.5,357.3 122.5,364.0 123.8,374.0 128.5,390.0 133.8,401.3 134.4,430.0 136.4,438.7 141.7,453.3 144.4,466.7 145.0,467.3 159.6,467.3 159.6,378.0 158.9,377.3 159.6,357.3 Z"
    };
